...
export type CatalogueGemstoneRole =
  | 'primary'
  | 'accent';

export type CatalogueGemstoneOrigin =
  | 'natural'
  | 'laboratory_grown';

export type CatalogueCertificationScope =
  | 'product'
  | 'per_unit';

export type CatalogueProductServiceType =
  | 'resizing'
  | 'engraving'
  | 'private_viewing'
  | 'care'
...
export interface CatalogueGemstoneGroupResponse {
  readonly role: CatalogueGemstoneRole;
  readonly gemstoneType: string;
  readonly origin: CatalogueGemstoneOrigin;
...
export interface CatalogueCertificateResponse {
  readonly scope: CatalogueCertificationScope;
...
export interface CatalogueProductServiceResponse {
  readonly serviceType: CatalogueProductServiceType;
